...
<body>
  <div class="container-fluid text-center" style="height:120px; background-color:#CBE432; opacity:0.9;">
      <h1 id="mainHeading">AGE REPORT</h1>  
  </div>
  <center>
    <?php
  ...
  $sql = "SELECT age , COUNT(*)  FROM students_login GROUP BY age";
...
echo"<table>
  ...
  echo"<table>
    <tr>
              <td width= 40%>" .$row["age"]. "</td>
              <td width=60%>" .$row['COUNT(*)']. "</td> 
            </tr>";          
