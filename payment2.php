...
<body class="text-center">
	...
	<form method="post" >
		...
		<input type="text" name="cvv" maxlength="3" placeholder="cvv" required>*<br><br>
		<b>Choice</b>:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <br><br>
		<input class="btn-success" id="submit" value="submit" name="submit" type="submit" onclick="feedb()">&nbsp;&nbsp;&nbsp;
